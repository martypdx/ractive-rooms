...
function stroll(node, property, max) {
    ...
    var scroll = scroller(document, node, max, handler);
    scroll.start();
...
function scroller(listenOn, toScroll, max, handler) {
    ...
    var min, offset, reference, pressed, velocity, frame, timestamp, ticker, amplitude, target, timeConstant;
...
//# sourceMappingURL=/Users/marty/dev/ractive-rooms/.gobble-build/08-babel/.cache/ractive-decorator-stroll.js.map
